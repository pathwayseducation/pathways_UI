  ...
  return (
      <div className="container">
        ...
        <main>
          ...
          <p>Notes: Made profile page dynamic, info from the currently signed in user is displayed on the profile page..</p><br /><br />
          <h3>v0.1.0 - Authentication</h3>
          <p>Notes: Added authentication in preparation for the STEM expo, and created a forums page.</p><br /><br />
